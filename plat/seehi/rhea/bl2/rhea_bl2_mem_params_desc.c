...
# if DEBUG
	  .ep_info.args.arg1 = RHEA_BL31_PLAT_PARAM_VAL,
# endif
	...
	{ .image_id = BL33_IMAGE_ID,
	  ...
	  .ep_info.pc = BL33_IMAGE_OFFSET,

	  SET_STATIC_PARAM_HEAD(image_info, PARAM_EP, VERSION_2, image_info_t,
				0),
	  .image_info.image_base = BL33_IMAGE_OFFSET,
	  .image_info.image_max_size = BL33_IMAGE_MAX_SIZE,
